...
stage=0
train_set=merged_train_960_cleaned    # you might set this to e.g. train_960
...
if [ $stage -le 3 ]; then
  ...
  for datadir in ${train_set}_sp test_deepgram test_elsa test_clean; do
...
if [ $stage -le 7 ]; then
  ...
  for data in test_deepgram test_elsa test_clean; do
